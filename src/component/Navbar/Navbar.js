...
const CustomNavbar = () => {
  ...
  return (
    <Navbar expand="lg" variant="dark" fixed="top" className="custom-navbar">
      <Container>
        <Navbar.Brand href="/">
          {/* Uncomment below when you have the MinnuLogo imported */}
          {/* <img src={MinnuLogo} width="40" height="40" className="d-inline-block align-top" alt="Minnu" /> */}
          Minnu
        </Navbar.Brand>
        {/* Conditionally render the toggler icon based on screen size */}
        <Navbar.Toggle
